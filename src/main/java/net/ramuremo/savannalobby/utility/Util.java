package net.ramuremo.savannalobby.utility;
...
public final class Util {
    public static boolean containsItemStack(ItemStack[] itemStacks, ItemStack target) {
        for (ItemStack itemStack : itemStacks) {
            if (itemStack == null) continue;
            if (itemStack.equals(target)) return true;
        }
        return false;
    }
